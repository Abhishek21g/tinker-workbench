...
2. `agent/EXECUTION_BOARD.md`
3. `agent/GITHUB_CONTRIBUTION_TARGETS.md`
4. `THINKING_MACHINES_RESEARCH.md`

Cursor's best lane right now:

- Do not start with a big UI.
- Help polish docs, README, and demo narrative.
